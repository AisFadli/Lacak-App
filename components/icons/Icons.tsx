...
export const TruckIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 17H6v-6h13l-3-6H6l-3 6v6h3" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 17H6v-6h13l-3-6H6l-3 6v6h3" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 11h4" />
  </svg>
);
